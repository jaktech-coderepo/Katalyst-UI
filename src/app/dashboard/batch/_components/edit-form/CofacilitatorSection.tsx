...
export type CofacilitatorSectionProps = {
  form: UseFormReturn<BatchEditType>;
  cofacilitators: {
    trainerFields: FieldArrayWithId<BatchEditType, 'cofacilitators', 'id'>[];
    appendTrainer: UseFieldArrayAppend<BatchEditType, 'cofacilitators'>;
