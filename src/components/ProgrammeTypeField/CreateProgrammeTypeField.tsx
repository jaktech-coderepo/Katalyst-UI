...
interface CreateProgrammeTypeFieldProps<T extends FieldValues> {
  name: FieldPath<T>;
...
export default function CreateProgrammeTypeField<T extends FieldValues>({
  name,
  setValue,
  trigger,
  error,
  ...
  TextFieldProps,
}: CreateProgrammeTypeFieldProps<T>) {
